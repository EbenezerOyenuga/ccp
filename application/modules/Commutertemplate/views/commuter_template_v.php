...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li><a href="<?php echo base_url(); ?>Admin/change_password"><i class="material-icons">lock</i>Change Password</a></li>
        ...
        <div class="menu">
            <ul class="list">
                <li class="header">COMMUTER NAVIGATION</li>
                <li>
                ...
                <li>
                    <a href="<?php echo base_url(); ?>Commuter/buy_ticket">
