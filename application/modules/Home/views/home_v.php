...
<html>
<head>
    <title>Corporate Campus Pickup | Home :: w3layouts</title>
    <!-- for-mobile-apps -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Corporate Campus Pickup, Univeristy, Nigeria, States" />
...
<div id="portfolio" class="portfolio">
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="view view-seventh">
                <a href="<?php echo base_url(); ?>asset/images/14.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                    <img src="<?php echo base_url(); ?>asset/images/14-.jpg" />
                    <div class="mask">
                        <h2>Necessitatibus</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                    </div>
        ...
        <div class="main">
            <div class="view view-seventh">
                <a href="<?php echo base_url(); ?>asset/images/15.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                    <img src="<?php echo base_url(); ?>asset/images/15-.jpg" />
                    <div class="mask">
                        <h2>Necessitatibus</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                    </div>
            ...
            <div class="view view-seventh">
                <a href="<?php echo base_url(); ?>asset/images/16.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                    <img src="<?php echo base_url(); ?>asset/images/16-.jpg" />
                    <div class="mask">
                        <h2>Necessitatibus</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                    </div>
            ...
            <div class="view view-seventh">
                <a href="<?php echo base_url(); ?>asset/images/17.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                    <img src="<?php echo base_url(); ?>asset/images/17-.jpg" />
                    <div class="mask">
                        <h2>Necessitatibus</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                    </div>
            ...
            <div class="view view-seventh">
                <a href="<?php echo base_url(); ?>asset/images/12.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                    <img src="<?php echo base_url(); ?>asset/images/12-.jpg" />
                    <div class="mask">
                        <h2>Necessitatibus</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                    </div>
        ...
        <div class="main">
            ...
            <div class="view view-seventh">
                <a href="<?php echo base_url(); ?>asset/images/13.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                    <img src="<?php echo base_url(); ?>asset/images/13-.jpg" />
                    <div class="mask">
                        <h2>Necessitatibus</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                    </div>
            ...
            <div class="view view-seventh">
                <a href="<?php echo base_url(); ?>asset/images/11.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                    <img src="<?php echo base_url(); ?>asset/images/11-.jpg" />
                    <div class="mask">
                        <h2>Necessitatibus</h2>
                        <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                    </div>
    ...
    <div class="container">
        ...
        <div class="events-grids">
            <div class="col-md-4 events-grid">
                <div class="cal">
                    <img src="<?php echo base_url(); ?>asset/images/3.png" alt=" " class="img-responsive" />
                    <div class="cal-info">
    ...
    <div class="container">
        ...
        <div class="men-heart-clock-twitter">
            <div class="col-md-3 men-text">
                <img src="<?php echo base_url(); ?>asset/images/men.png" alt=" " />
                <div class="men-txt">
            ...
            <div class="col-md-3 men-text">
                <img src="<?php echo base_url(); ?>asset/images/heart.png" alt=" " />
                <div class="men-txt">
            ...
            <div class="col-md-3 men-text">
                <img src="<?php echo base_url(); ?>asset/images/clock.png" alt=" " />
                <div class="men-txt">
            ...
            <div class="col-md-3 men-text">
                <img src="<?php echo base_url(); ?>asset/images/twitter.png" alt=" " />
                <div class="men-txt">
