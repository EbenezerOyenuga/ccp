                ...
                <script type="text/javascript">
                    ...
                    function change_gender() {
                        if (document.getElementById("genderdd").value == 2){
                            var xmlhttp = new XMLHttpRequest();
                            xmlhttp.open("GET", "<?php echo base_url(); ?>Gender/create_user_select_gender?role="+document.getElementById("genderdd").value, false);
                            xmlhttp.send(null);
